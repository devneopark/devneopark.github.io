...
class BuildTest(unittest.TestCase):
    ...
    def test_build_creates_pages_and_removes_stale_generated_files(self):
        ...
        index_html = (self.project_root / "dist/index.html").read_text(encoding="utf-8")
        self.assertIn('/assets/js/posts.mjs', index_html)
        self.assertNotIn(">Home<", index_html)
        self.assertIn('id="site-footer"', index_html)
        self.assertIn("mailto:dev.neopark@gmail.com", index_html)
        self.assertIn("https://github.com/devneopark", index_html)
